    ...
    if (inventory.length > 0) {
        ...
        for (ingredient of Object.keys(inventoryObj)) {
            ...
            if (inventoryObj[ingredient] > 0) {
                ...
                updatedStr += ingredient + "@@" + inventoryObj[ingredient] + "**"
                ...
                valueUpdateBox.id = "valueUpdate" + ingredient
                valueUpdateBox.type = "number"
                valueUpdateBox.setAttribute("min", "1")
        ...
        updatedStr = updatedStr.slice(0,updatedStr.length-2)
        console.log(updatedStr)
        localStorage.setItem("inventory", JSON.stringify(updatedStr));
    }
}
...
function addByNum(item) {
    ...
    var amt = document.getElementById("valueUpdate" + item).value
    console.log(amt)
